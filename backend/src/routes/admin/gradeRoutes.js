...
const { validateResult, gradeValidationRules, gradeUpdateValidationRules } = require('../../middleware/validator');
...
router.post('/', gradeValidationRules, validateResult, gradeController.createGrade);
router.put('/:id', gradeUpdateValidationRules, validateResult, gradeController.updateGrade);
